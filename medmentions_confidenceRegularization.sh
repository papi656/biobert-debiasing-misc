...
python evaluate.py \
    ...
    --predictions resources/MedMentions/preds_model_Confidence_regularization.txt 
...
# python inference.py \
#     --dataset_name MedMentions \
#     --model_name model_30epochs_Confidence_regularization \
#     --loss_fn Confidence_regularization
...
#     --gold_labels datasets/MedMentions/test.txt \
#     --gold_cuis datasets/MedMentions/test_cuis.txt \
#     --predictions resources/MedMentions/preds_model_30epochs_Confidence_regularization.txt 
